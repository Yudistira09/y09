...
ulang:
 echo "\e[93m[+] Masukin Nomor GOJEK Kamu Disini : ";
 ...
 if ($logins->success == true) {
     otp:
         ...
         if ($verifs->success == true) {
             ...
             $live = "token-akun.txt";
             $fopen1 = fopen($live, "a+");
             $fwrite1 = fwrite($fopen1, "\e[93Token Kamu : " . $token . "
...
";
             ...
             echo "
";
             echo "\e[91mYah Kode OTP Salah, Coba Kamu Ulangi Lagi Deh!
";
             echo "
";
             goto otp;
         ...
         echo "
";
         echo "\e[91mYah Gagal Mengirim Kode OTP, Gunakan Nomor Yang Sudah Terdaftar Di GOJEK Yah!
";
         echo "
";
         goto ulang;
